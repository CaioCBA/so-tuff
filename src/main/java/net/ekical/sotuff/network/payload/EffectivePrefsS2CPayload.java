...
public record EffectivePrefsS2CPayload(boolean perAction, double actionChance, double freq01, boolean vary, boolean bars,
    ...
    public static final PacketCodec<RegistryByteBuf, EffectivePrefsS2CPayload> CODEC =
            PacketCodec.tuple(
                    ...
                    PacketCodecs.DOUBLE,   EffectivePrefsS2CPayload::actionChance,
