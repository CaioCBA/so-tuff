...
public record ClientPrefsC2SPayload(boolean perAction, double actionChance, double freq01, boolean vary, boolean bars,
    ...
    public static final PacketCodec<RegistryByteBuf, ClientPrefsC2SPayload> CODEC =
            PacketCodec.tuple(
                    ...
                    PacketCodecs.DOUBLE,   ClientPrefsC2SPayload::actionChance,
